...
class _PickerScreenState extends State<PickerScreen> {
  LatLng dicodingOffice = const LatLng(-6.8957473, 107.6337669);
  ...
  void onMyLocationButtonPress() async {
    ...
    dicodingOffice = LatLng(locationData.latitude!, locationData.longitude!);
    ...
    return Consumer(
      builder: (context, ref, child) {
        return GestureDetector(
          onTap: () {
            ref.read(latitudeControllerProvider).text =
                location.latitude.toString();
            ref.read(longitudeControllerProvider).text =
